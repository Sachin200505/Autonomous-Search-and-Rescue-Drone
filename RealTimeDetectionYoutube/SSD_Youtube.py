...
PROTOTXT = "/utilities/SSD_deploy.prototxt" # Specify path for .prototxt and .caffemodel
MODEL = "/utilities/SSD.caffemodel"
URL =  "https://studio.youtube.com/video/y8nAB6KA6R4/livestreaming" # Youtube url
